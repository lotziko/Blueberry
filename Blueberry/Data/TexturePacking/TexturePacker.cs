...
namespace Blueberry.DataTools
{
    public class TexturePacker
    {
        ...
        public void Pack(string input, string output, string name, bool recursive, IContentExporter exporter)
        {
            ...
            exporter?.Export(output, name, new AtlasExportData() { pages = pages, settings = settings });
        }
    ...
    public class TextureArea : PackerRect
    {
        ...
        public int[] splits;
        public int[] pads;
        public int offsetX, offsetY, originalWidth, originalHeight, regionWidth, regionHeight;
        ...
        public TextureArea(TextureArea src) : base(src)
        {
            ...
            regionWidth = src.regionWidth;
            regionHeight = src.regionHeight;
            index = src.index;
            rotated = src.rotated;
            splits = src.splits;
            pads = src.pads;
