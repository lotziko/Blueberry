...
namespace Blueberry
{
    public class GestureDetector : InputAdapter
    {
        ...
        private Vec2 pointer2 = new Vec2();
        private Vec2 initialPointer1 = new Vec2();
        private Vec2 initialPointer2 = new Vec2();
    ...
    public class GestureAdapter : IGestureListener
    {
        ...
        public virtual bool Pinch(Vec2 initialPointer1, Vec2 initialPointer2, Vec2 pointer1, Vec2 pointer2)
        {
            return false;
        }
