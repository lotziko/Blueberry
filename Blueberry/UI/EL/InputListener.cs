namespace Blueberry.UI
{
    public abstract class InputListener : IEventListener
    {
        ...
        public bool Handle(Event e)
        {
            ...
            ev.ToCoordinates(ev.GetListenerElement(), ref tmpCoords.X, ref tmpCoords.Y);
        ...
        public virtual bool Scrolled(InputEvent ev, float x, float y, float amountX, float amountY)
        {
            return false;
        }
