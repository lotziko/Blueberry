...
namespace Blueberry.UI
{
    public class MenuItem : Button
    {
        ...
        private Label label;
        private Col shortcutLabelColor;
        ...
        internal void ShowSubMenu()
        {
            ...
            LocalToStageCoordinates(ref pos.X, ref pos.Y);

            float availableSpaceLeft = pos.X;
            float availableSpaceRight = stage.Width - (pos.X + GetWidth());
            bool canFitOnTheRight = pos.X + GetWidth() + subMenu.GetWidth() <= stage.Width;
            float subMenuX;
        ...
        public override void Draw(Graphics graphics, float parentAlpha)
        {
            ...
            else if (IsPressed() && style.downFontColor != Col.Transparent)
            ...
            if (fontColor != Col.Transparent) label.GetStyle().fontColor = fontColor;
	     ...
	     * @return this object for the purpose of chaining methods
	     */
        public MenuItem SetShortcut(params Key[] keys)
        {
            var str = "";
