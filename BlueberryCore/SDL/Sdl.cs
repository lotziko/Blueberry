...
internal static class Sdl
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate IntPtr d_sdl_addeventwatch(EventFilter filter, IntPtr userdata);
    public static d_sdl_addeventwatch SDL_AddEventWatch = FuncLoader.LoadFunction<d_sdl_addeventwatch>(NativeLibrary, "SDL_AddEventWatch");

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int EventFilter(IntPtr userdata, Event sdlevent);
