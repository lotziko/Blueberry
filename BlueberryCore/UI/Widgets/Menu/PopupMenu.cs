    ...
    public class PopupMenu : Table
    {
        ...
        private class StageListener : InputListener
        {
            ...
            public override bool KeyDown(InputEvent ev, int keycode)
            {
                ...
                if (keycode == (int)Keys.Left && menu.activeItem.containerMenu.parentSubMenu != null)
                {
                    menu.activeItem.containerMenu.parentSubMenu.SetActiveSubMenu(null);
                }

                if (keycode == (int)Keys.Right && menu.activeItem.GetSubMenu() != null)
                {
        ...
        {
            return GetDefaultInputListener(MouseButton.RIGHT);
        }

        public InputListener GetDefaultInputListener(MouseButton mouseButton)
        {
        ...
        private class DefaultInputListener : InputListener
        {
            ...
            private readonly PopupMenu menu;
            public DefaultInputListener(PopupMenu menu, MouseButton mouseButton)
            {
                this.menu = menu;
        ...
        {
            var pos = element.LocalToStageCoordinates(Vector2.Zero);
            float menuY;
